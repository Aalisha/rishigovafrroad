    ...
    return {
      ...
      link: function(scope, elem, attrs, ctrl) {
        ...
        scope.$on('angucomplete-alt:clearInput', function (event, elementId) {
         ...
         scope.$on('angucomplete-alt:setInput', function (event, inputvalue, elementId) {
          if (inputvalue && scope.id === elementId) {
            scope.searchStr = inputvalue;
          }
        });

         scope.$on('angucomplete-alt:NotchClick', function (event, elementId) {
            if (scope.id === elementId) {
                if(scope.showDropdown == false || scope.showDropdown == undefined)
                {
        ...
        scope.onFocusHandler = function() {
          ...
          {
            scope.results = scope.localData;
            scope.showDropdown = true;
            processResults(scope.results,'b');
          }
        };
