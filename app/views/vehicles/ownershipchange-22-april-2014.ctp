    ...
    <div class="innerbody">
        ...
        <table width="100%" border="0" cellpadding="3">
            <tr>
                ...
                <td  valign='top' width="17%"><label class="lab-inner1">Company Name :</label></td>
                <td valign='top'  width="25%">
                    <?php
            ...
            <tr>
                ...
                <td valign='top'>
                    <?php
					//pr($this->Session->read('Auth.Profile'));
                    echo $this->Form->input('CustomerAmendment.vc_customer_name', array('label' => false,
                        'div' => false,
                        'type' => 'text',
                        'id' => 'vc_customer_name',
                        'disabled' => 'disabled',
                        'value' => $this->Session->read('Auth.Profile.vc_company_name'),
                        'class' => 'round'));
                    ?>
                ...
                <td valign='top'>
                    ...
                    echo $this->Form->input('CustomerAmendment.vc_customer_id', array('label' => false,
                        ...
                        'disabled' => 'disabled',
                        'id' => 'vc_customer_id',
                        'value' => $this->Session->read('Auth.Profile.vc_business_reg'),
                        'class' => 'round'));
                    ?>
