...
<div class="wrapper">
    ...
    <?php echo $this->Form->create('Vehicle', array('url' => array('controller' => 'vehicles', 'action' => 'cbc_editvehicle',$edit['AddVehicle']['nu_vehicle_id'], 'cbc' => true),'type' => 'file')); ?>
            ...
            <table width="99%" cellspacing="1" cellpadding="5" border="0" >
               <thead>	
					<tr class="listhead">
						...
						<td width="11%">No. of Axle</td>
						<td width="10%">Series Name</td>
						<td width="10%">Engine No.</td>
						<td width="10%">Chassis No.</td> 
						<td width="10%">V Rating</td>
						<td width="10%">D/T Rating</td>
				   ...
				   <tr class="cont1">
						...
						<td valign='top' width="8%">
							...
							<?php
								 ...
								 echo $this->Form->input('AddVehicle.0.nu_vehicle_id', array('label' => false,
									'type' => 'hidden',
									'value'=>$edit['AddVehicle']['nu_vehicle_id']
									));
							?>
                            <?php
							echo $this->Form->input('AddVehicle.id', array('label' => false,
								'div' => false,
								'type' => 'hidden',
								'id' => 'id',
								'value' => $id,
                            ...
                            <?php
								echo $this->Form->input('AddVehicle.0.vc_veh_type', array('label' => false,
									'type' => 'select',
									'required' => 'required',
									'default'=>$edit['AddVehicle']['vc_veh_type'],
									'options' => $CustType,
									'class' => 'round_select1'));
                            ?>
                        ...
                        <td valign='top' width="8%">
                            ...
                            echo $this->Form->input('AddVehicle.0.vc_reg_no', array('label' => false,
                                ...
                                'type' => 'text',
                                'id' => 'vc_reg_no',
								'value' => $edit['AddVehicle']['vc_reg_no'],
                                'required' => 'required',
                                'maxlength' => '30',
                                'class' => 'round4'));
                            ?>
                        ...
                        <td valign='top' width="8%">
                            <?php 
								echo $this->Form->input('AddVehicle.0.vc_type_no', array('label' => false,
									...
									'required' => 'required',
									'options' => $vehtype,
									'default'=>$edit['AddVehicle']['vc_type_no'],
									'maxlength' => '30',
									'class' => 'round_select1')
								);
                            ?>
                        ...
                        <td valign='top' width="8%">
                            <?php
                             echo $this->Form->input('AddVehicle.0.vc_make', array('label' => false,
                                ...
                                'required' => 'required',
                                'id' => 'vc_make',
								'default'=>$edit['AddVehicle']['vc_make'],
                                'options' => $vehtype3,
                                'maxlength' => '30',
                                'class' => 'round_select1')
                            );
                        ...
                        <td valign='top' width="10%">
                            ...
                            echo $this->Form->input('AddVehicle.0.vc_axle_type', array('label' => false,
                                ...
                                'id' => 'vc_axle_no',
                                'options' => $vehtype1,
								'default'=>$edit['AddVehicle']['vc_axle_type'],
                                'required' => 'required',
                        ...
                        <td valign='top'  width="10%">
                            <?php
                              echo $this->Form->input('AddVehicle.0.vc_series_name', array('label' => false,
                                ...
                                'type' => 'text',
                                'id' => 'vc_series_name',
								'value' => $edit['AddVehicle']['vc_series_name'],
                                'maxlength' => '15',
                                'class' => 'round4'));
                            ?>
                        ...
                        <td valign='top' width="10%">
                            <?php
                             echo $this->Form->input('AddVehicle.0.vc_engine_no', array('label' => false,
                                ...
                                'type' => 'text',
                                'id' => 'vc_engine_no',
                                'value' => $edit['AddVehicle']['vc_engine_no'],
                                'maxlength' => '15',
                                'class' => 'round4'));
                            ?>
                        ...
                        <td valign='top' width="10%">
                            <?php
                             echo $this->Form->input('AddVehicle.0.vc_chasis_no', array('label' => false,
                                ...
                                'type' => 'text',
                                'id' => 'vc_chasis_no',
                                'value' =>  $edit['AddVehicle']['vc_chasis_no'],
                                'maxlength' => '15',
                                'class' => 'round4'));
                            ?>

                        </td>
                        <td valign='top' width="10%" title = "The V-value is indicated on your licence disk is the TARRA (the Minimum capacity in Kg a certain truck is able to draw or carry; usually it’s the smaller number)">
                            <?php
                             echo $this->Form->input('AddVehicle.0.nu_v_rating', array('label' => false,
                                'div' => false,
                                'type' => 'text',
                                'id' => 'nu_v_rating',
                                'value' =>  $edit['AddVehicle']['nu_v_rating'],
                                'maxlength' => '15',
                                'class' => 'number-right round4'));
                            ?>

                        </td>
                        <td valign='top' width="10%" title = "The D-value is indicated on your licence disk (the Maximum capacity in Kg a certain truck or trailer is able to draw or carry; usually it’s a big number GVM)">
                            <?php
                             echo $this->Form->input('AddVehicle.0.nu_d_rating', array('label' => false,
                                'div' => false,
                                'type' => 'text',
                                'id' => 'nu_d_rating',
                                'value' => $edit['AddVehicle']['nu_d_rating'],
                                'maxlength' => '15',
                                'class' => 'number-right round4'));
                            ?>
...
<?php echo $this->Html->script('cbc/editvehicle'); ?>
