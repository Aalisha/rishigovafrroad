<?php $customerdetails = $this->Session->read('Auth'); ?>
...
<div class="mainbody">
    ...
    <?php echo $this->Form->create('VehicleRegistration', array('url' => array('controller' => 'vehicles', 'action' => 'edit', base64_encode(trim($data['VehicleDetail']['vc_registration_detail_id']))), 'type' => 'file')); ?>
    <div class="innerbody">
        ...
        <table width="100%" border="0" cellpadding="3">
            ...
            <tr>
                ...
                </td> <td><label class="lab-inner">Mobile No. :</label></td>
                <td>
                    <?php
    ...
    <div class="innerbody">
       <div class='list'>
	   <table id='changedetailvehicleID' width="100%" cellspacing="1" cellpadding="5" border="0" >
           <thead >

				<tr class="listhead">
					<td width="6%">Vehicle <br/>Status</td>
					<td width="8%">Company <br/>Name</td>				
                ...
                <tr>
                    <td  valign ='top'  width="100%" align="left">
						...
						<div >
							...
							<td width="10%">&nbsp;&nbsp;&nbsp; <a href="<?php echo $url;?>">View</a></td><td width="60%" align="left">&nbsp;
							<a rel="<?php echo base64_encode($value['DocumentUploadVehicle']['vc_upload_vehicle_id']);?>" id="deletefileID<?php echo base64_encode($value['DocumentUploadVehicle']['vc_upload_vehicle_id']); ?>"
href="#">Delete</a>
							</td></tr>
							<?php 
							$docsnum++;
...
<!-- end mainbody here-->   
<?php echo $this->Html->script('mdc/vehicles-edit'); ?> 
<style>
.innerbody {
