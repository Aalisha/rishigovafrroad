...
<div class="mainbody">
    ...
    <div class="innerbody">
        <?php echo $this->Form->create(array('url' => array('controller' => 'vehicles', 'action' => 'ownershipchange'), 'type' => 'file')); ?>
        ...
        <table width="100%" border="0" cellpadding="3">
            <tr>
                ...
                <td  valign='top' width="25%">
                    ...
                    ?>
					<input type="hidden" value="<?php if(isset($vc_cust_type) && $vc_cust_type!='') echo $vc_cust_type;?>" name ="data[CustomerAmendment][vc_cust_type]" id="vc_cust_type">
                ...
                <td valign='top' width="13%" ><label class="lab-inner1">ID No./Register No. :</label></td>
			 ...
			 <tr>
                ...
                <td width="37%">
                    ...
                    echo $this->Form->input(null, array('label' => false,
                        ...
                        'disabled' => 'disabled',
                        'id' => null,
                        'value' => $this->Session->read('Auth.Profile.vc_town'),
                        'class' => 'round'));
                    ?>
                </td>
                <td width="13%">&nbsp;</td>
