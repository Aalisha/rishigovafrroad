    ...
    <div class="mainbody" style="width:93%" >
        ...
        <table width="100%" border="0">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<tr><td><div id="filesdata"></div></td></tr>
            </table>       
...
<?php echo $this->Html->script('flr/addclaimcheck'); ?>
	...
	b=a[0];
	if(b<9){ 
	  $('#flashversion').text('Please upgrade the version of flash in order to use one time upload.');
	}else{
	//alert('ha'+b);
	}
...
/**/	
	...
	'onQueueComplete':function(){
		...
		var lengthOfswfs = parseInt($('.uploadify-queue-item').length);
			...
			/// delete code on click of remove 
				...
				$("input[id *='input_allfileupload_values_']").each(function(){
					...
					if($.trim($(this).val())==$.trim($('#divid-'+relvalue).val())){
						...
						$.post( "claims/deleteajaxuploadify", { filename: removeItem } );
