...
<div class="header">
    ...
    <div class="header-main">
        ...
        <div class="logo">
            <?php
            if ($loggedIn):
                $url = $this->Html->url(array('controller' => 'profiles', 'action' => 'index'));
            else :
        ...
        <div class="nevigation">
            ...
            <ul class="dropdown">
                ...
                <?php foreach ($mdcHeaderNavigation as $key => $values) : ?>
        ...
        <div class="header-right">
            ...
            <div class="logout">  Hello <?php echo ucfirst(substr(trim($this->Session->read('Auth.Member.vc_user_firstname')), 0, 1)) .' '.ucfirst(trim($this->Session->read('Auth.Member.vc_user_lastname'))); ?>  | <?php echo $this->Html->link('Logout', array('controller' => 'members', 'action' => 'logout')); ?>
            </div>      
        </div>
