...
<tr>
                    <td width="5%" valign="top"><label style="width:70px;" class="lab-inner">Vehicle Lic No./Reg No.</label></td>
                    <td width="15%" valign="top" colspan='4' class="align-left">
                        <?php
...
>>>>>>> .r2612
                    ...
                    <td width="15%"  valign="top" align="left" class="align-left"></td>
        ...
        <div id='ajaxdata' class="innerbody">
            ...
            <table width="100%" border="0" cellpadding="3" class ="customersInfo" style="">
                ...
                <tr>
                    ...
                    <td width="14%"><span class="valuetext"><?php echo $profile['Profile']['vc_customer_no']; ?></span></td>
                    <td width="2%">
                    ...
                    <td  width="10%" align ="left"><span class="valuetext"><?php echo $vehicletypename;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-align:right;padding-left:30px;">
...
<?php					if (count($vehiclereport) > 0):
                ...
                <tr>
                    ...
                    <td width="14%"><span class="valuetext"><?php
			...
			<?php if (empty($nu_company_id)) { ?>
                ...
                <tr class="listhead1">
					...
					<td width="15%" align="center">Vehicle Reg. No.</td>
