...
<div class="wrapper">
    ...
    <div class="breadcrumb">
        <ul>
            ...
            <li class="last">Client Claim</li>      <li class="last clientnoclass"   >Client No.&nbsp;:&nbsp;<?php echo $this->Session->read('Auth.Client.vc_client_no');?></li>    
        </ul>
    </div>
    <!-- end breadcrumb here-->
    <!-- Start mainbody here-->
...
<?php  echo $this->Html->script('flr/claimsavecheck'); ?>
   ...
   // 'cancelImg' : '/uploadify/cancel.png',
    ...
    'onUploadSuccess': function(fileObj,response,data){     
		...
		for(var index in arrayfileValue){
		   ...
		   var inputhiddenfile="<input type='hidden'  name='"+textboxname+"' value='"+arrayfileValue[index]+"' />";
...
/*	'onQueueComplete':function(){
		...
		//console.log(lengthOfswfs);

		for (var loopval='<?php echo $cnt;?>';loopval<lengthOfswfs;loopval++){
