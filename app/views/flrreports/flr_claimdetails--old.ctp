    ...
    <div class="mainbody">
        ...
        <div class="innerbody">
            <table width="100%" border="0" cellpadding="3">
                <tr>
                    <td><label class="lab-inner">Client ID :</label></td>
                    <td>	
                        <?php
                        echo $this->Form->input(null, array('label' => false,
                            ...
                            'type' => 'text',
                            'disabled' => 'disabled',
                            'value' => $this->Session->read('Auth.Client.vc_client_no'),
                            'class' => 'round'));
                        ?>
                    </td>
            ...
            <table width="100%" cellspacing="1" cellpadding="5" border="0">
                <tr class="listhead1">
                    ...
                    <td width="10%" align="center">Invoice Date</td>
                    <td width="10%" align="center">Fuel Outlet</td>
                    <td width="10%" align="center">Fuel Volume (ltrs)</td>
                    <td width="10%" align="center">Refund Rate</td>
                    <td width="11%" align="center">Invoice Status</td>
                    <td width="14%" align="center">Reason for <br/>rejection</td>
                    <td width="10%" align="center">Amount (N$)</td>
                </tr>
                <?php
                $total_amount = 0;
				$total_liters = 0;
