	 ...
	 <td>
		...
		<td valign = "top">
			...
			if($balanceamt>0){
				...
				echo $this->Form->button('Pay Proof', array(
				'label' => false,
				'div' => false,
				'type' => 'submit',
				'onClick' => "alert('Pay outstanding amount to get pay proof');return false;",
				'class' => 'submit'));
			...
			<?php	echo $this->Form->button('Statement', array(
				'label' => false,
				'div' => false,
				'type' => 'submit',
				'onClick' => "callaction('statement')",
				'class' => 'submit'));
			?>
		</td>
	 </tr>
...
<td valign='top' ><label class="lab-inner">Mobile No. :</label></td>
		...
		<td valign='top' >
			...
			echo $this->Form->input('vc_cust_type', array('label' => false,
				...
				'type' => 'text',
				'id' => 'vc_cust_type',
			    'value'=>trim($globalParameterarray[$data['CustomerProfile']['vc_cust_type']]),
				'class' => 'round disabled-field'));
			?>
			<!--<input type="text" class="round" />-->
		</td>
