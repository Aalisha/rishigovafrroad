...
<div class="form-body clearfix">
	...
	<div class="form-body-heading">
		<div class="heading">Inspector <?php echo strtoupper($selectedType);?> Login  </div>  
	</div> 
	...
	<div class="form-body-main">
		...
		<div class="form-body-mainbody">
			...
			<?php echo $this->Form->create('Inspector', array('url' => array('controller' => 'inspectors', 'action' => 'login',$selectedTypeID))); ?>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td valign="top">
						<?php echo $this->Form->input('vc_username', array( 'label' =>false, 'div'=>false, 'type' => 'text', 	'id'=>'vc_username' , 'required'=>'required','class'=>'fiel')); ?>
					</td>	
				</tr>
				...
				<tr>
					...
					<td valign="top">
						<?php echo $this->Form->input('vc_password', array( 'label' =>false, 'div'=>false, 'type' => 'password', 'id'=>'vc_password' , 'required'=>'required', 'class'=>'fiel')); ?>
					</td>
				</tr>
				...
				<tr>                     
					<td>&nbsp;</td>
					<td><?php echo $this->Html->link(' Forgot Password ? ', array('controller'=>'inspectors', 'action'=>'forgotpassword', $selectedTypeID)); ?></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><?php echo $this->Html->link(' New User ? Register Now ! ', array('controller'=>'inspectors', 'action'=>'registration', $selectedTypeID)); ?></td>
			</tr>
...
<!-- end form-body here--> 
<?php echo $this->Html->script('inspector/inspector-login'); ?>