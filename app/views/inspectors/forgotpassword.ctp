...
<div class="form-body clearfix">
	...
	<div class="form-body-heading">
		<div class="heading"><?php echo strtoupper($selectedType);?>-Inspector Forgot Password</div>  
	</div> 
	...
	<div class="form-body-main">
		...
		<div class="form-body-mainbody">
			...
			<?php echo $this->Form->create('Inspector', array('url' => array('controller' => 'inspectors', 'action' => 'forgotpassword',$selectedTypeID))); ?>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td valign="top">
						<?php echo $this->Form->input('vc_email_id_frgt', array( 'label' =>false,'required'=>'required',  'div'=>false, 'type' => 'text',  'id'=>'email' , 'class'=>'fiel')); ?>
					</td>
				</tr>
...
<!-- end form-body here-->  
<?php echo $this->Html->script('inspector/inspector-forgotpassword'); ?>