<div class="wrapper">
    ...
    <div class="breadcrumb">
        <ul>
            ...
            <li class="last">Inspector Feedback Form</li>        
        </ul>
    </div>
    <!-- end breadcrumb here-->
        ...
        <div class="innerbody">
            ...
            <table width="100%" border="0" cellpadding="3">
				 ...
				 <tr>
                    ...
                    <td valign='top' ><label class="lab-inner" style="width:130px;">Vehicle Register No. :</label></td>
                    <td valign='top'>
                        <?php
...
<td valign='top' ><label class="lab-inner">Mobile No. :</label></td>
                ...
                <tr><td valign='top' ><label class="lab-inner">Pay Frequency :</label></td>
        ...
        <div class="innerbody  listsr1"  style='overflow-y: visible !important;' >
            <table width="100%" cellspacing="1" cellpadding="5" border="0" >
               <thead> 
					<tr class="listhead ">
						<td width="13"  >Select Road</td>
						<td width="10%" >Date</td>
						<td width="10%" >Driver Name</td>
						<td width="10%" >Start Odometer</td>
						<td width="8%" >End Odometer</td>
						<td width="10%">Origin Road </td>
						<td width="10%" >Destination Road</td>
						<td width="9%" >KM Travel on Road</td>
						<td width="8%" >Upload Docs.</td>
				...
				<tbody id='tbody1'>
					...
					<tr class="cont1">
						...
						<td valign="top" style='text-align:center;' colspan='12' width="100%">
							...
							Please Select Vehicle License No. / Register No.
...
<?php echo $this->Html->script('inspector/inspector-feedback'); ?>