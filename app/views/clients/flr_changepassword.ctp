...
<?php
					if (isset($loggedIn) &&  !empty($loggedIn)):
						...
						if ($this->Session->read('Auth.Member.vc_flr_customer_no') == '') :
							...
							$url = array('controller' => 'clients', 'action' => 'index', 'flr' => true);
						...
						elseif ($this->Session->read('Auth.Client.ch_active_flag') == 'STSTY05'):
							...
							$url = array('controller' => 'clients', 'action' => 'view', 'flr' => true);
        ...
        <li class="last">Change Password</li>     <li class="last clientnoclass" style=""  >Client No.&nbsp;:&nbsp;<?php echo ltrim($this->Session->read('Auth.Client.vc_client_no'),'01');?></li>     
    </ul>
</div>
<!-- end breadcrumb here-->
...
<div class="mainbody">
    ...
    <div class="innerbody">
       ...
       <?php echo $this->Form->create('Client',array('url' => array('controller' => 'clients', 'action' => 'changepassword'))); ?>
...
<?php echo $this->Html->script('flr/change-password'); ?>