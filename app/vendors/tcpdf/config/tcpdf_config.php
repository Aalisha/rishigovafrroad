 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', WWW_HOST .'img/');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'RFA - Namibia');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'RFA');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Road Funds Administration - Namibia');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "RFA - Namibia");
