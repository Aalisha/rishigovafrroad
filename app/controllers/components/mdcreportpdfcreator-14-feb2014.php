...
class MdcReportpdfcreatorComponent extends FPDF {
    ...
    function genrate_mdc_vehiclereport($columnsHeadings, $data, $allconstants, $toDate = null, $fromDate = null, $vehicletypename = NULL,$nu_company_id=null,$CompanyName) {
        ...
        $columnwidtharrays = array(10,25,25,20,20,25,20,20,20);
        ...
        if ($this->PageNo() == 1) {
            ...
            if ((isset($fromDate) && !empty($fromDate)) || (isset($toDate) && !empty($toDate)) ||
                ...
                if (isset($fromDate) && !empty($fromDate))
                    $this->MultiCell(20, 8, date('d M Y', strtotime($fromDate)), 0, '', 'L', true);
                else
                    $this->MultiCell(20, 8, '', 0, '', 'L', true);
                ...
                if (isset($toDate) && !empty($toDate))
                    $this->MultiCell(20, 8, date('d M Y', strtotime($toDate)), 0, '', 'L', true);
                else
                    $this->MultiCell(20, 8, '', 0, '', 'L', true);
                ...
                if (isset($vehicletypename) && !empty($vehicletypename))
                    $this->MultiCell(25, 8, $vehicletypename, 0, '', 'L', true);
                else
                ...
                if (isset($nu_company_id) && !empty($nu_company_id))
                    $this->MultiCell(35, 8,ucfirst($CompanyName[$nu_company_id]), 0, '', 'L', true);
                else
